...
import LoginModal from '../Componentes/LoginModal'; // Asegúrate de poner la ruta correcta
    ...
    <div>
      ...
      <Navbar.Collapse id="navbarScroll">
        ...
        >
          ...
          {/* Botón de Login */}
          <Button variant="primary" className="ms-2" onClick={handleOpenLoginModal}>
            Login
          </Button>
        </Navbar.Collapse>
        ...
        <LoginModal showModal={showLoginModal} handleClose={handleCloseLoginModal} />
      </Container>
    </Navbar>
  );
}
